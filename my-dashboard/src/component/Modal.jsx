...
const Modal = ({ task, onClose, onSave, categorySelector }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 backdrop-blur-sm">
      ...
      <div
        className="bg-white dark:bg-black rounded-2xl p-6 w-full max-w-md shadow-2xl border border-gray-800 animate-fade-in text-black dark:text-white"
      ...
      >
        ...
        <label className="block mb-4">
          ...
          <input
            ref={titleInputRef}
            className={`w-full border rounded px-3 py-2 mt-1 text-sm bg-white dark:bg-gray-900 text-black dark:text-white focus:outline-none focus:ring-2
