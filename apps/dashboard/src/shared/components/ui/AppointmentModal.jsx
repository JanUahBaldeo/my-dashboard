                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <div
                          ...
                          className="w-full cursor-pointer rounded-xl border-2 border-gray-200 bg-gray-50 px-4 py-3 transition-all duration-200 hover:border-gray-300 focus-within:border-blue-400 focus-within:bg-white focus-within:outline-none focus-within:ring-3 focus-within:ring-blue-100"
                        >
                          <div className="flex items-center justify-between">
                            {form.calendar && calendarOptions.find((o) => o.value === form.calendar) ? (
                              ...
                              <span className="font-medium text-gray-500">Select a calendar...</span>
                            )}
                            <FiChevronDown
                              className={`ml-3 h-5 w-5 flex-shrink-0 text-gray-400 transition-transform ${
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="relative space-y-2">
                              ...
                              <div className="relative">
                                ...
                                />
                                <FiCalendar className="absolute right-3 top-1/2 h-5 w-5 -translate-y-1/2 text-gray-400" />
                              </div>
                              {errors.date && (
                                <p className="flex items-center text-sm font-medium text-red-600">
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="relative">
                                <input
                                  ...
                                  className={`w-full rounded-xl border-2 px-4 py-3 pr-10 text-base font-medium transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-blue-100 ${
                                    errors.startTime
                                      ? 'border-red-300 bg-red-50 focus:border-red-400 focus:ring-red-100'
