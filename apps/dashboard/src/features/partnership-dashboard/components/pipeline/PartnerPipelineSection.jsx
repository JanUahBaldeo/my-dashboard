...
const PartnerPipelineSection = ({ isAdmin = false }) => {
  ...
  const handleManualRefresh = async () => {
    ...
    try {
      await manualRefresh();
      toast.success('✅ Partner pipeline data refreshed!');
    } catch (error) {
      ...
      <section className="w-full p-8">
        <div className="flex flex-col items-center justify-center h-64 space-y-4">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            {loadingProgress.message || 'Loading partner pipeline data...'}
          </p>
      ...
      <section className="w-full p-8">
        <div className="text-center">
          <div className="text-red-500 mb-4">
            <p className="text-lg font-semibold mb-2">Partner Pipeline Error</p>
  ...
  return (
    ...
    >
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                title="Refresh partner pipeline data"
              >
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-4">
            ...
            <div className="flex flex-1 items-center gap-4">
              ...
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  type="text"
                  placeholder="Search partner leads by name, type, or tags..."
                  value={searchQuery}
          ...
          <div className="px-8 py-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600 font-medium">Total Partner Leads</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600 mb-1">
                  {metrics?.conversionRate || 0}%
                </div>
                <div className="text-sm text-gray-600 font-medium">Partner Conversion Rate</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600 font-medium">Total Partner Value</div>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      <div className="p-4 lg:p-8">
        ...
        >
          <div className="flex gap-3 lg:gap-6 overflow-x-auto pb-6 kanban-scrollbar min-h-[600px]">
          ...
          <DragOverlay>
            {activeLead ? (
              <PartnerKanbanCard lead={activeLead} isDragging />
            ) : null}
          </DragOverlay>
        </DndContext>
        ...
        {filteredStages.length === 0 && (
          <div className="text-center py-16">
            <div className="text-gray-400 text-xl mb-3 font-medium">
              No partner pipeline stages found
            </div>
            <div className="text-gray-500 text-sm">
              Try adjusting your filter or check your partner pipeline configuration.
            </div>
          </div>
        )}
      </div>
